  ...
  return (
    <>
      ...
      <div className="space-y-16">
        {/* Two-Column Layout: Send a Message (Left) and Book a Meeting (Right) */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          {/* Calendly Booking - Right Column */}
          <div>
            <h3 className="text-3xl font-bold mb-6 text-gray-900 dark:text-gray-100">Book a Meeting</h3>
            <p className="text-gray-600 dark:text-gray-400 mb-8">
